...
export const NAV_ITEMS = [
  ...
  { key: "financeiro", label: "Financeiro", icon: IconFinance, path: (t) => `/painel/${t}/financeiro`, soon: true },
  { key: "estoque", label: "Estoque", icon: IconStock, path: (t) => `/painel/${t}/estoque`, soon: true },
  { key: "relatorios", label: "Relatórios", icon: IconReports, path: (t) => `/painel/${t}/relatorios`, soon: true },
  { key: "config", label: "Configurações", icon: IconSettings, path: (t) => `/painel/${t}/configuracoes`, soon: true },
];
